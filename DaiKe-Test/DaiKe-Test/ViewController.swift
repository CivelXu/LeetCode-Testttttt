...
//  DaiKe-Test
//
//  Created by xuxiwen on 2017/10/18.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let testArray1 = [1, 2, 3, 4]
         _ = productArray(inputArray: testArray1)
        
        let testArray2 = [0, 1, 0, 3, 12]
         _ = NumberFirst(input: testArray2)
        
        let result =  Power(num1: 2, num2: 2)
        debugPrint("\(result)")
     }

 
    // MARK: - 1. Product array
